...
export function SearchNotesSidebar() {
  ...
  return (
    <Sidebar.Container className="B-search-notes_search-notes px-4 py-4">
      <Sidebar.ItemContainer className="">
        <SearchInput
          searchQuery={rawSearchQuery}
          updateSearchQuery={updateRawSearchQuery}
        />
      </Sidebar.ItemContainer>
      <Sidebar.ItemContainer className="flex flex-row justify-between pt-1 pb-2 text-xs">
        {searchResults && (
          <span className="">
