...
const FZF_SEARCH_LIMIT = 200;
const RECENT_SHOW_LIMIT = 6;
const MAX_RECENTLY_USED_ITEMS = 5;
const MAX_RECENTLY_USED_ITEMS_NO_QUERY = 200;
    ...
    return (
      <>
        ...
        <UniversalPalette.PaletteInfo>
          ...
          <UniversalPalette.PaletteInfoItem>
            <kbd className="font-normal">↑↓</kbd> Выбор
          </UniversalPalette.PaletteInfoItem>
          <UniversalPalette.PaletteInfoItem>
            <kbd className="font-normal">Enter</kbd> Открыть
          </UniversalPalette.PaletteInfoItem>
          <UniversalPalette.PaletteInfoItem>
            <kbd className="font-normal">Shift-Enter</kbd> Открыть рядом
          </UniversalPalette.PaletteInfoItem>
          <UniversalPalette.PaletteInfoItem>
...
export const notesPalette: ExtensionPaletteType = {
  ...
  identifierPrefix: '',
  placeholder: "Поиск записи (? - варианты).",
