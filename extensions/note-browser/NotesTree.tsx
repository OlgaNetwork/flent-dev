...
const RenderItems = ({
  ...
  return (
    <div ref={parentRef} style={{ height: '100%', overflow: 'auto' }}>
      <div
        style={{
          height: `${rowVirtualizer.totalSize*1.5}px`,
          width: '100%',
          position: 'relative',
        }}
      >
  ...
  return (
    <div
      ...
      style={{
        ...
        transform: `translateY(${virtualRow.start*1.4}px)`,
      }}
    >
      <Sidebar.Row2
        isActive={isActive}
        ...
        item={{
          ...
          leftNode: (
            <ButtonIcon onClick={async (e) => {}}>
              {isDir ? (
                isCollapsed ? (
                      <svg class="w-4 h-4 mt-1.5 mr-1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="2 2 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m9 18 6-6-6-6"/></svg>
                ) : (
                      <svg class="w-4 h-4 mt-1 mr-1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m18 15-6-6-6 6"/></svg>
                )
              ) : (
                     null
