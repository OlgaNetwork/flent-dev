  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col mb-5">
        <div className="mb-2">
          <h2 className="text-lg font-medium">Расположение</h2>
          <span className="text-sm text-colorNeutralTextSubdued">
            Выберите папку, в которую Flent поместит все ваши заметки. Вы можете использовать существующую папку или создать новую.
            В этой папке могут, например, находиться ваши файлы с расширением .md (например, от Notion).
