...
const staticHints = [
  PaletteItem.create({
    ...
    title: 'Ссылка на другую заметку',
    description: `Введите [[, а затем имя заметки, чтобы создать ссылку на нее.`,
  ...
  return reactDOM.createPortal(
    <div className="B-ui-components_inline-palette-wrapper flex flex-col bg-colorNeutralBgLayerFloat shadow-2xl">
      ...
      <UniversalPalette.PaletteInfo>
        ...
        <UniversalPalette.PaletteInfoItem>
          <kbd className="font-normal">Enter</kbd> Выполнить команду
        </UniversalPalette.PaletteInfoItem>
        <UniversalPalette.PaletteInfoItem>
          <kbd className="font-normal">Esc</kbd> Отмена
        </UniversalPalette.PaletteInfoItem>
      </UniversalPalette.PaletteInfo>
    </div>,
    tooltipContentDOM,
